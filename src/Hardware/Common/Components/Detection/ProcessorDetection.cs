...
public class ProcessorDetection : BaseDetection
{
    protected override ProcessorModel DetectWindows()
    {
        ...
        processorModel.SupportsVirtualization =
            Boolean.Parse(windowsAnalyzer.GetWMIValue("VirtualizationFirmwareEnabled", "Win32_Processor"));
