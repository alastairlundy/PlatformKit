...
public class BaseDetection
{
    ...
    protected virtual ComponentModel DetectMac()
    {
        throw new NotImplementedException();
    }
    
    protected virtual ComponentModel DetectLinux()
    {
        throw new NotImplementedException();
    }
    
    protected virtual ComponentModel DetectWindows()
    {
        throw new NotImplementedException();
    }

    public ComponentModel Detect()
    {
